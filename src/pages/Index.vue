      ...
      <section id="website-project">
        <div>
          ...
          <p>
            ...
            palveluiden prototyyppaamisessa. Henkilökohtainen oppimisen ollessa
            yksi osa palkastani, pystyn toteutaamaan projektisi kohtuu
            kustannuksin.
          </p>
          <button class="btn">Aloitetaan projekti yhdessä!</button>
        </div>
        <div>
          <h3>Projektin kulku</h3>
          ...
          <div class="project-step">
            ...
            <p>
              ...
              yhdessä läpi. Katsotaan että kaikki tarvittavat elementit löytyvät
              ja että sivun asettelu on haluamasi mukainen.
            </p>
          </div>
          <div class="project-step">
            <h4>Toteutus</h4>
            <p>
              Pistetään näppäimistö sauhuamaan! Toteutan ensimmäisen käytettävän
              prototyypin (MVP) ja testataan toimivuus yhdessä.
            </p>
          </div>
          <div class="project-step">
            <h4>Viimeistely</h4>
          ...
          <div class="project-step">
            ...
            <p>
              ...
              löydettävissä ja pidetään huoli että ne myös löytyvät. Halutessasi
              voimme lisätä projektiin analytiikkaa jonka avulla toimintaa ja
